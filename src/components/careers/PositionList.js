...
function PositionList() {
    return (
        <div className="max-w-full mx-12 bg-white">
            {/* mx-20 py-18 max-w-full text-2xl font-medium text-gray-800 */}
            <h2 className="text-2xl font-semibold text-gray-900 mx-12 pb-8">List Position</h2>
            <p className="text-xl font-medium text-gray-500 mx-12 max-w-4xl leading-10">Let's write some beautiful code and make smart designs. This is what we're crazy about, and we're looking for the ones who feel the same.</p>
