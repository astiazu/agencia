        ...
        <div className="relative px-4 pt-16 pb-20 sm:px-6 lg:px-8 lg:pb-28">
            ...
            <div className="relative mx-auto max-w-full">
                <div className="text-center">
                    ...
                    <p className="mx-auto mt-3 max-w-2xl text-xl pb-12 text-gray-500 sm:mt-4">
                ...
                <Carousel
                    ...
                    {/* <div className="mx-auto xl:mx-12 mt-12 grid max-w-lg gap-40 lg:max-w-full lg:grid-cols-2">
                    </div> */}
                </Carousel>
            </div>
        </div>
